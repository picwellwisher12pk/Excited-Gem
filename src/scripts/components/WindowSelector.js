...
export default class WindowSelector extends React.Component {
  ...
  render() {
    ...
    let currentWindowTabs = this.state.currentWindow.tabs
      ? this.state.currentWindow.tabs.length
      : 0;
    let totalTabCount = this.state.browserWindows.reduce(function (
      total,
      window
    ) {
            ...
            <li className="list-group-item">
              ...
              >
                ...
                <span
                  className={
                    `count badge badge-` +
                    (totalTabCount > 50 ? `warning` : `success`)
                  }
                  title="Tab Count"
                >
                  {totalTabCount}
            ...
            <li className="list-group-item ">
              ...
              >
                ...
                <span
                  className={
                    `count badge badge-` +
                    (currentWindowTabs > 50 ? `warning` : `success`)
                  }
                  title="Tab Count"
                >
                  {currentWindowTabs}
              ...
              >
                ...
                >
                  ...
                  <span
                    className={
                      `count badge badge-` +
                      (window.tabs.length > 50 ? `warning` : `success`)
                    }
                    title="Tab Count"
                  >
                    {window.tabs.length}
